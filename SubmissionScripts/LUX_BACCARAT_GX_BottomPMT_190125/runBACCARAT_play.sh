...
mkdir /scratch/rossiter/luxGXAnalysis_190125
mkdir /scratch/rossiter/luxGXAnalysis_190125/$ijob
mkdir /data/rossiter/lz/baccarat/luxGXAnalysis_1e7_190125

export OUTPUT_DIR=/scratch/rossiter/luxGXAnalysis_190125/$ijob
cd $OUTPUT_DIR							
BACCARAT_DIR=/home/rossiter/LUX/GammaX_sims/LUX_BACCARAT_190123
...
MACRO_FILE=/home/rossiter/SubmissionScripts/LUX_BACCARAT_GX_BottomPMT_190125/PETERbottomPMT.mac
...
echo "DONE."
cp $OUTPUT_DIR/$OUTPUT_ROOT_FILE /data/rossiter/lz/baccarat/luxGXAnalysis_1e7_190125/$OUTPUT_ROOT_FILE

rm -r /scratch/rossiter/luxGXAnalysis_190125/$ijob
