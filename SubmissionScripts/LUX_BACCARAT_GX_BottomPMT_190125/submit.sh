...
do     
    condor_qsub -V -o $LOGDIR/output$i.txt -e $LOGDIR/output$i.err -v ijob="$i",LOGDIR="$LOGDIR" $home/SubmissionScripts/LUX_BACCARAT_GX_BottomPMT_190125/runBACCARAT_play.sh -l mem=1.2G
