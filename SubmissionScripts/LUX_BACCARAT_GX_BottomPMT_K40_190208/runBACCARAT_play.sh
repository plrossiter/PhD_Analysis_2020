...
mkdir /data/rossiter/lz/baccarat/luxGXAnalysis_1e7_K40_190208
...
MACRO_FILE=/home/rossiter/SubmissionScripts/LUX_BACCARAT_GX_BottomPMT_K40_190208/PETERbottomPMT_K40.mac
...
echo "DONE."
cp $OUTPUT_DIR/$OUTPUT_ROOT_FILE /data/rossiter/lz/baccarat/luxGXAnalysis_1e7_K40_190208/$OUTPUT_ROOT_FILE
