...
mkdir /data/rossiter/lz/baccarat/luxGXAnalysis_1e7_Co60_190208
...
MACRO_FILE=/home/rossiter/SubmissionScripts/LUX_BACCARAT_GX_BottomPMT_Co60_190208/PETERbottomPMT_Co60.mac
...
echo "DONE."
cp $OUTPUT_DIR/$OUTPUT_ROOT_FILE /data/rossiter/lz/baccarat/luxGXAnalysis_1e7_Co60_190208/$OUTPUT_ROOT_FILE
